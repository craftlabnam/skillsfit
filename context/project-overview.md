...
SkillsFit eliminates all of that preparation work. The agent finds the jobs, scores them intelligently against the user's actual skills, and researches each company so the user arrives at every application fully informed. The user just decides which ones to apply to and clicks.
...
- Company Research section:
  ...
  - Powered by Firecrawl + Stagehand browsing the company's public pages
...
- Company Research Agent — single Firecrawl session browses company public pages, GPT-4o builds dossier
